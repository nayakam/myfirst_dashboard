/**
 * Test file for Job: freemem2
 */

var assert = require ('assert');
var freemem2_SUT = require('../freemem2');

var mockedConfig, mockedDependencies;

describe ('freemem2 test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      freemem2_SUT.onRun(config, mockedDependencies, function(err, data){
