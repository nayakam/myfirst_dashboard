...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/freemem file)
     ...
     Have a look at test/freemem for an example of how to unit tests this easily by mocking easyRequest calls
